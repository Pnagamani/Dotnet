<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LAPTOP.aspx.cs" Inherits="WebApplication1.WebForm6" %>
    ...
    <center>
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="lblDprice" runat="server" Text="Rs.90000"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
